  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `MovieEntity` (`movieID` INTEGER NOT NULL, `title` TEXT, `description` TEXT, `releaseDate` TEXT, `adult` INTEGER NOT NULL, `status` TEXT, `duration` INTEGER NOT NULL, `popularity` INTEGER NOT NULL, PRIMARY KEY(`movieID`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '5714105691ec4d144d8ff6bf9028fe2c')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsMovieEntity = new HashMap<String, TableInfo.Column>(8);
    ...
    }, "5714105691ec4d144d8ff6bf9028fe2c", "e25c2c22b5e00921ad0cdd56a346e794");
